...
10. **Tailscale (VPN) — DO ZROBIENIA PRZED URUCHOMIENIEM.** Zdalny dostęp do peceta/WMS bez
    wystawiania portów na świat; potrzebny gdy Node stanie na Windows (dostęp z Zebr/desktopów
    i serwis zdalny). Osobny krok, przy przenosinach Node.
